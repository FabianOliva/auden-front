        ...
        <>
            <BackgroundB>
                ...
                <div className='crear-playlist-container'>
                    <span className='cpc-tituloA fade-in-right'><h3>Como se llamará tu playlist?</h3></span>
                    <span className='cpc-subtituloB fade-in-left'><h5>Nombre de la playlist:</h5></span>
